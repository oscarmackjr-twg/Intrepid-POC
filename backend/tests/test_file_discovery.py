...
class TestFindFileByPattern:
    ...
    def test_find_with_date_substitution(self, temp_dir):
        ...
        result = find_file_by_pattern(str(temp_dir), "Tape20Loans_{date}.csv", date_str="10-21-2025", required=False)
        assert result == test_file
...
class TestDiscoverInputFiles:
    ...
    def test_discover_all_files(self, sample_input_dir):
        ...
        files = discover_input_files(str(sample_input_dir), yesterday, sfy_date=None, prime_date=None)
