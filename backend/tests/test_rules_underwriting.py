...
class TestCheckUnderwriting:
    ...
    def test_pass_criteria(self, sample_buy_df, sample_underwriting_df):
        ...
        flagged, min_income = check_underwriting(
            buy_df, sample_underwriting_df, sample_underwriting_df, is_notes=False, tuloans=[]
        )
    ...
    def test_notes_loans(self, sample_underwriting_df):
        ...
        flagged, min_income = check_underwriting(
            buy_df, sample_underwriting_df, sample_underwriting_df, is_notes=True, tuloans=[]
        )
    ...
    def test_tuloans_exclusion(self, sample_underwriting_df):
        ...
        flagged, min_income = check_underwriting(
            buy_df, sample_underwriting_df, sample_underwriting_df, is_notes=False, tuloans=["SFC_1001"]
        )
...
class TestGetUnderwritingExceptions:
    ...
    def test_exception_generation(self, sample_buy_df):
        ...
        exceptions = get_underwriting_exceptions(sample_buy_df, flagged_loans, exception_type="underwriting")
