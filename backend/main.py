...
def main():
    ...
    parser.add_argument("--folder", type=str, default=settings.INPUT_DIR, help="Input folder path")
    parser.add_argument("--pdate", type=str, default=None, help="Purchase date (YYYY-MM-DD)")
    parser.add_argument("--irr-target", type=float, default=settings.IRR_TARGET, help="IRR target percentage")
    ...
    context = RunContext.create(
        sales_team_id=args.sales_team_id, created_by_id=None, pdate=args.pdate, irr_target=args.irr_target
    )
