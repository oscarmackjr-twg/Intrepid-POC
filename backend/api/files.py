...
async def list_files(
    ...
    try:
        ...
        return {
            "path": path,
            "files": [
                {"path": f.path, "size": f.size, "is_directory": f.is_directory, "last_modified": f.last_modified}
                for f in files
            ],
        }
...
async def upload_file(
    ...
    try:
        ...
        return {"message": "File uploaded successfully", "path": dest_path, "size": len(content)}
