...
def check_input_files(folder: str = None):
    ...
    if sfy_files:
        ...
        print("  ❌ No SFY files found (pattern: SFY_*_ExhibitAtoFormofSaleNotice - Pre-Funding.xlsx)")
    ...
    if prime_files:
        ...
        print("  ❌ No PRIME files found (pattern: PRIME_*_ExhibitAtoFormofSaleNotice - Pre-Funding.xlsx)")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--folder", type=str, default=None, help="Input folder path (default: from settings.INPUT_DIR)")
