...
if __name__ == "__main__":
    ...
    parser.add_argument("--username", default="admin", help="Admin username to reset (default: admin)")
    parser.add_argument("--password", default="admin123", help="New password (default: admin123)")

    args = parser.parse_args()

    reset_admin_password(username=args.username, new_password=args.password)
